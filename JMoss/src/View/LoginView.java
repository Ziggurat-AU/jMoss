...
public class LoginView {
	...
	private void showCinemas() throws Exception {
	...
	private void makeBooking(String cinemaName) throws Exception  {
			
		 Scanner sc=new Scanner(System.in);
		         SessionController sessionController=new SessionController();
		         ArrayList<View.Model.SessionModel> movies = new ArrayList<View.Model.SessionModel>();
		         System.out.println("Welcome to jMOSS- Java based Movie Search System");
		         System.out.println("------------------------------------------------");
